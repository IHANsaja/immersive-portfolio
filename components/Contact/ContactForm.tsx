    ...
    useGSAP(() => {
        ...
        const enter = () => {
            ...
            gsap.to(wrapper.querySelectorAll('.circle'), {
                scale: 1.2,
                filter: "drop-shadow(0 0 10px #F9CF46)",
                duration: 0.3,
                ease: "power2.out",
                stagger: 0.1
            });
    ...
    return (
        <div className="contact-form w-full h-full bg-background relative">
            ...
            <div className="w-full h-full relative z-4">
                <div className="absolute top-1/2 -translate-y-1/2 -left-16 rotate-90 font-inconsolata-sans">
                    <p className="scrambleContact sclines opacity-0">|||||||||||||||||||</p>
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 top-0 pt-2 font-inconsolata-sans">
                    <p className="scrambleContact sclines opacity-0">|||||||||||||||||||</p>
                </div>
                <div className="absolute top-1/2 -translate-y-1/2 -right-16 rotate-90 font-inconsolata-sans">
                    <p className="scrambleContact sclines opacity-0">|||||||||||||||||||</p>
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 bottom-0 pb-2 font-inconsolata-sans">
                    <p className="scrambleContact sclines opacity-0">|||||||||||||||||||</p>
                </div>
            </div>

            <form className="Cform absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
