...
export class AssetPreloader {
    ...
    private initializeAssets() {
        ...
        const images = [
            ...
            '/images/battlezik.jpg',
            '/images/ecovibe.jpg',
            '/images/freya.jpeg',
            '/images/heritagelink.jpg',
            '/images/imagegang.jpg',
            '/images/nextstep.jpg',
            '/images/outbreak.jpg',
            '/images/serendib.jpg',
            '/images/zenofy.jpg',
        ...
        const audioFiles = [
            ...
            '/sounds/reject.wav',
            '/voices/ProjectBattlezik.mp3',
            '/voices/ProjectCinec.mp3',
            '/voices/ProjectEcovibe.mp3',
            '/voices/ProjectFreya.mp3',
            '/voices/ProjectHeritage.mp3',
            '/voices/ProjectImageGang.mp3',
            '/voices/ProjectNS.mp3',
            '/voices/ProjectOutbreak.mp3',
